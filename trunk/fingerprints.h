...
KN_FP_MASK def_kn_fp_mask[]=
	...
	{"client_Icq_bigmir)net",	"ICQ*bigmir*", 		"ICQ Lite v5 (bigmir)net)",	NULL, IDI_CLIENTICQ_BIGMIR, 0xFF,1},
	...
	{"client_Icq_pro7", 		"ICQ*Pro7*", 		"ICQ Lite v5 (Pro7)",	NULL, IDI_CLIENTICQ_PRO7, 0xFF,1},
	...
	{"client_ICQ Lite v5.1",	"icq5.1*",		"ICQ Lite v5.1",	NULL, IDI_CLIENTICQLITE51,0xFF,1},
	{"client_icq5",			"icq5*",		"ICQ5",			NULL, IDI_CLIENTICQLITE5,0xFF,1},
