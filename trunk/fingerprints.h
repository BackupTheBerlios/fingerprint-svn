...
KN_FP_MASK def_kn_fp_mask[]=
	...
	{"client_Miranda0.4",       "Miranda IM 0.4*",         "Miranda IM 0.4.x",          NULL, IDI_CLIENTMIRANDA04,0xFF,6},
	...
	{"client_MSN 8.x",          "MSN 8.*",	           "MSN 8.x", 	            NULL, IDI_CLIENTMSN8,0xFF,7},
 	...
 	{"client_MSN 4.x-5.x",      "|MSN 4.*|MSN 5.*",	   "MSN 4.x-5.x", 	        NULL, IDI_CLIENTMSN4_5,0xFF,7},
