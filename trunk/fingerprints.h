...
KN_FP_MASK def_kn_fp_mask[]=
	...
	{"client_Miranda BM",       "|Miranda*ICQ v1.3*|Miranda*BM*", "Miranda IM ICQ_BM)",	NULL, IDI_CLIENTMIRANDA_ICQBM,0xFF,6},
	{"client_Miranda ICQJ",     "Miranda*ICQ v0.3*",    "Miranda IM ICQJ",   	NULL, IDI_CLIENTMIRANDA_ICQJ,0xFF,6},
	{"client_Miranda ISee",     "Miranda*ICQ v0.4*",    "Miranda IM ISee",	    NULL, IDI_CLIENTMIRANDA_ICQISEE,0xFF,6},
	{"client_Miranda S7",       "|Miranda*S7*|Miranda*ICQ v2.3*", "Miranda IM ICQ_S7",NULL, IDI_CLIENTMIRANDA_S7,0xFF,6},
	{"client_Miranda AimOscar", "Miranda*AimOscar*",    "Miranda IM AimOscar",  NULL, IDI_CLIENTMIRANDA_AIMOSCAR,0xFF,6},
	{"client_Miranda IRC",      "Miranda*IRC v 0.6*",   "Miranda IM IRC",       NULL, IDI_CLIENTMIRANDAIRC,0xFF,6},
	{"client_Miranda IRC mod",  "Miranda*IRC v 0.7*",   "Miranda IM IRC mod",   NULL, IDI_CLIENTMIRANDAIRCMOD,0xFF,6},
	{"client_Miranda0.4",       "|Miranda*0.4*|Miranda*0.3*","Miranda IM 0.4.x-0.3.x", NULL, IDI_CLIENTMIRANDA04,0xFF,6},
	{"client_Miranda0.5",       "Miranda*0.5*",         "Miranda IM 0.5.x",     NULL, IDI_CLIENTMIRANDA05,0xFF,6},
	{"client_Miranda0.6",       "|Miranda*0.6*|Miranda*","Miranda IM 0.6.x",    NULL, IDI_CLIENTMIRANDA06,0xFF,6},
	...
	{"client_ICQ for Mac",      "ICQ*Mac*",             "ICQ for Mac",          NULL, IDI_CLIENTICQMAC,0xFF,1},
	...
	{"client_Icq_abv",          "ICQ*Abv*",             "ICQ v5 [ABV]",         NULL, IDI_CLIENTICQ_ABV, 0xFF,1},
	{"client_Icq_netvigator",   "ICQ*Netvigator*",      "ICQ v5 [Netvigator]",  NULL, IDI_CLIENTICQ_NETVIGATOR, 0xFF,1},
	{"client_Icq_rambler",      "ICQ*Rambler*",         "ICQ v5 [Rambler]",     NULL, IDI_CLIENTICQ_RAMBLER, 0xFF,1},
	{"client_Icq4pocket PC",    "ICQ*pocket*",          "ICQ pocket PC",        NULL, IDI_CLIENTICQ4POCKET, 0xFF,1},
	{"client_ICQ Lite v4",      "ICQ Lite v4*",         "ICQ Lite v4",          NULL, IDI_CLIENTICQLITE4,0xFF,1},
	{"client_ICQ Lite v5.1",    "|ICQ Lite v5.1*|icq5.1*","ICQ v5.1",           NULL, IDI_CLIENTICQLITE51,0xFF,1},
	{"client_ICQ Lite v5",      "|ICQ Lite v5*|icq5*",  "ICQ v5",               NULL, IDI_CLIENTICQLITE5,0xFF,1},
	...
	{"client_pyICQ",            "pyICQ*",               "pyICQ",                NULL, IDI_CLIENTPYICQ,0xFF,1},
	...
	{"client_WTW",              "*WTW",                 "WTW",                  NULL, IDI_CLIENTWTW, 0xFF,2},
	{"client_Tlen",             "*tlen.pl",             "Tlen.pl",              NULL, IDI_CLIENTTLEN, 0xFF,2},
	...
	{"client_GTalk on BlackBerry","ICS5B*",             "GTalk on BlackBerry",  NULL, IDI_CLIENTGTBB,0xFF,4},
	...
	{"client-uTorrent",         "*torrent*",            "uTorrent",             NULL, IDI_CLIENTUTORRENT,0xFF,9},
